 ...
 * \return  int
 */
int controller_listEstructura(LinkedList* pArrayListEstructura);
 ...
 * \return  int     -   Debug
 */
 int edit_name(Estructura *auxEstructura);
 ...
 * \return  int     -   Debug
 */
int edit_hours(Estructura *auxEstructura);
 ...
 * \return  int     -   Debug
 */
int edit_salary(Estructura *auxEstructura);
