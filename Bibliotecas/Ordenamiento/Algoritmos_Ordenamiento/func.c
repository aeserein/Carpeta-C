...
/*  Nadia sort  -   Recibe y un índice mínimo y compacta
                    Trabaja con dos arrays, uno ordenado y el que va compactando

    Insertion   -   Empieza por 1, pasa hacia atrás y rellena el slot que se mueve.

    Burbujeo    -   Del primero al anteúltimo y del segundo al último.
                    Hace swap

    Quick Sort  -   Un pivor size/2 y un for de 5 argumentos

    Selection sort  -   Calcula índice mínimo de un array + 1 (?)
                    -   Hace swap
